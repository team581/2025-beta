...
public enum RobotState {
  ...
  CLAW_EMPTY_DEPLOY_EMPTY(
      ClawGamePiece.EMPTY, /* deployHasCoral= */ false, /* climbingOrRehoming= */ false),
  /** Deploy is holding coral, claw isn't doing anything. */
  CLAW_EMPTY_DEPLOY_CORAL(
      ClawGamePiece.EMPTY, /* deployHasCoral= */ true, /* climbingOrRehoming= */ false),
  /** Claw holding algae, deploy is holding coral. */
  CLAW_ALGAE_DEPLOY_CORAL(
      ClawGamePiece.ALGAE, /* deployHasCoral= */ true, /* climbingOrRehoming= */ false),
  /** Claw holding algae, deploy is empty. */
  CLAW_ALGAE_DEPLOY_EMPTY(
      ClawGamePiece.ALGAE, /* deployHasCoral= */ false, /* climbingOrRehoming= */ false),
  /** Claw holding coral, deploy is empty. */
  CLAW_CORAL_DEPLOY_EMPTY(
      ClawGamePiece.CORAL, /* deployHasCoral= */ false, /* climbingOrRehoming= */ false),
  ...
  // Climbing states
  CLIMBING_1_LINEUP(
      ClawGamePiece.EMPTY, /* deployHasCoral= */ false, /* climbingOrRehoming= */ true),
  CLIMBING_2_HANGING(
      ClawGamePiece.EMPTY, /* deployHasCoral= */ false, /* climbingOrRehoming= */ true),
