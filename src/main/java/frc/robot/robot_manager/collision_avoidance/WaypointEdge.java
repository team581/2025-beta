...
public record WaypointEdge(
  ...
  public WaypointEdge(
      ...
      ObstructionStrategy leftSideStrategy,
      ObstructionStrategy rightSideStrategy) {
    this(from.costFor(to),from.costFor(to)+STATIC_COST, false, leftSideStrategy, rightSideStrategy);
  }
